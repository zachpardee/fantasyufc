...
const styles = StyleSheet.create({
  ...
  editBtn: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 6, borderWidth: 1, borderColor: '#c8102e' },
  editText: { color: '#c8102e', fontSize: 13, fontWeight: '600' },
  cancelBtn: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 6, borderWidth: 1, borderColor: '#555' },
  cancelText: { color: '#999', fontSize: 13, fontWeight: '600' },
  saveBtn: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 6, backgroundColor: '#c8102e' },
  ...
  slotToggle: { paddingHorizontal: 10, paddingVertical: 8, borderRadius: 5 },
