...
function statusBadgeStyle(status: string): React.CSSProperties {
  ...
  return { background: '#222', color: colors[status] ?? '#888', fontSize: 12, padding: '4px 10px', borderRadius: 4, fontWeight: 700 };
}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  pickLabel: { color: '#fff', fontSize: 18, fontWeight: 700 },
  timer: {
  ...
  controlBtn: { background: '#2a2a2a', border: '1px solid #444', borderRadius: 6, color: '#ccc', padding: '6px 14px', cursor: 'pointer', fontSize: 14 },
  toast: {
  ...
  myTurnText: { color: '#4caf50', fontWeight: 700, fontSize: 16 },
  waitingText: { color: '#888', fontSize: 14 },
  completeBanner: {
    background: '#1a1a1a', borderBottom: '1px solid #333',
    padding: '32px 24px', textAlign: 'center',
  },
  completeTitle: { color: '#fff', fontSize: 20, fontWeight: 700, margin: '0 0 6px' },
  ...
  panelTitle: { color: '#888', fontSize: 12, fontWeight: 700, letterSpacing: 1, textTransform: 'uppercase', margin: '0 0 12px', display: 'flex', alignItems: 'center', gap: 8 },
  availCount: { background: '#333', color: '#aaa', borderRadius: 10, padding: '1px 7px', fontSize: 12, fontWeight: 700 },
  ...
  roundHeader: { color: '#555', fontSize: 12, fontWeight: 700, marginBottom: 6 },
  ...
  champ: { background: '#2a2400', color: '#ffd700', fontSize: 9, fontWeight: 700, padding: '1px 5px', borderRadius: 3, flexShrink: 0 },
  fighterName: { color: '#ddd', fontSize: 14, fontWeight: 600 },
  fighterWC: { color: '#555', fontSize: 12, marginTop: 1 },
