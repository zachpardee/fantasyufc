    ...
    return (
      <div style={styles.container}>
        <div style={styles.card}>
          ...
          <p style={styles.hint}>
            Using Supabase? You can disable email confirmation in<br />
            <strong style={{ color: '#aaa' }}>Authentication → Settings → Email confirmations</strong>
          </p>
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <input style={styles.input} placeholder="Username (letters, numbers, _)" value={username}
            onChange={(e) => setUsername(e.target.value)} required pattern="[a-zA-Z0-9_]+" />
          <input style={styles.input} placeholder="Display Name (optional)" value={displayName}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: { background: '#1a1a1a', borderRadius: 12, padding: 40, width: '100%', maxWidth: 440, border: '1px solid #333' },
  title: { color: '#fff', fontSize: 28, marginBottom: 28 },
