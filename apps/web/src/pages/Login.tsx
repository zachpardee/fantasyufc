            ...
            <div style={styles.howToBody}>
              ...
              <div style={styles.step}>
                ...
                <div>
                  ...
                  <div style={styles.stepText}>
                    Each UFC event, pick the fight winners and how they'll win. (Staking leagues bet
                    a weekly budget on fights instead.)
                  </div>
                </div>
              </div>
              <div style={styles.step}>
                ...
                <div>
                  ...
                  <div style={styles.stepText}>
                    Your score faces a different league member every event. Most points takes the
                    win.
                  </div>
                </div>
              </div>
              <div style={styles.step}>
                ...
                <div>
                  ...
                  <div style={styles.stepText}>
                    Rack up wins, reach the playoffs, and claim the title.
                  </div>
                </div>
              </div>
            </div>
