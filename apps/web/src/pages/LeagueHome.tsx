...
const styles: Record<string, React.CSSProperties> = {
  ...
  sheetOverlay: { position: 'fixed' as const, inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 200, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' },
  bottomSheet: { background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: '16px 16px 0 0', width: '100%', maxWidth: 600, maxHeight: '60vh', display: 'flex', flexDirection: 'column' as const },
