...
const styles: Record<string, React.CSSProperties> = {
  ...
  bottomSheet: { background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: 16, width: '90%', maxWidth: 560, maxHeight: '70vh', display: 'flex', flexDirection: 'column' as const },
  ...
  fightRowVs: { color: '#333', fontSize: 10, fontWeight: 700, letterSpacing: 1 },
