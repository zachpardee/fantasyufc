...
function isEventLocked(event: {
  ...
  // Only the top-6 fights are stakeable and none of them are early prelims, so a
  // 'live' event (early prelims underway) doesn't lock betting when a prelims start
