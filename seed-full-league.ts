...
import { generateMatchupsForLeague, finalizeMatchupResults } from './apps/api/src/services/matchup.service';
...
// ── Existing users ──────────────────────────────────────────────────────────
const EXISTING = [
  { userId: 'e3361f5c-8cde-4e61-b8b2-6232be71f53e', email: 'zach@fantasyufc.dev',        teamName: 'Blue Thunder',   isCommissioner: true },
  { userId: '908aab05-2b41-4529-899a-4db71e9fb659', email: 'zachattack877@comcast.net',  teamName: 'Red Squad',      isCommissioner: false },
];
...
const FIGHTERS = [
  'e0ef4beb-5b9a-42ab-a20e-b86cc9e17e60','e73383ae-9856-4519-9312-384bcae7778f',
  '5d5b7178-3ed7-4b10-8fe2-65b446c18a91','6096a0a1-7e11-4fdb-9cc2-e96c70773bca',
  'b525929b-4826-4962-af8e-1b0f73c1d886','a1804fc8-3c36-41ec-b6b5-63b461b1ca28',
  '55d34817-7e84-4214-a7e2-226b957027f0','d70a6900-4162-484b-93e7-691daca853e2',
  '435442e8-bf4f-44fb-b993-b86117b8a9d1','30cc78d3-1938-493d-a26c-ee15d0e0fd3e',
  'f572ffab-b514-4e6d-95b4-27136587735b','b372463b-b273-4618-a5d7-dc034b5ff2af',
  '92304cf4-ba13-46e1-825e-37627b3badbb','183f332d-c438-4f28-8e49-ae2c40bd9018',
  'd9327f51-e934-413c-88df-d7fd3abca23e','24b3def7-0ed7-4820-ab5f-3f9dc2368cb6',
  '625dd9e7-38ed-4a0d-afce-b31158ffcce2','4037514d-1e20-41f1-8354-6385f125bc48',
  'bbb8eb57-d98a-4cea-a505-42d63a1a8153','e0be9bd5-ac8a-44bb-bd5c-c512282e090d',
  '2d8f4f5f-00a5-4faf-be70-dfe3479fe1d8','f9a01b9a-070a-400a-847e-a14acb724650',
  'c6881695-983c-4cd8-88e5-b19758d993a4','98d488e8-a3f4-403a-b281-8a8b3ad281ab',
  'e4607afe-6fc2-4677-8bb7-c12976f0dc1e','0b21b4a8-596c-4c9e-89b9-d929e2e967ba',
  'a99d4d64-add1-4ed8-b3a3-049a3054dc27','a230e399-5eff-479a-96b8-9395a3d8e951',
  'e23b2377-052a-4c2f-8eab-24281580a164','be8f896a-3e1a-4acb-a911-e56edd75324f',
  '54615d1f-2e6b-4377-8384-85b8507d324d','46fae21f-af70-4228-87c8-ca3c721046a0',
  '5faaf9c9-2a03-4111-9cd3-2f78e40224f5','b19a64f3-902e-44f9-ad92-b5571b9843d7',
  'c51a026e-ae1e-4389-a56e-a0092a8af1ae','8037560d-aff1-45f8-9099-85b0c56b6e09',
  'acedcb89-72cd-4b1b-a156-f0b58ee75ad7','5d9a7e00-ad49-498b-bb53-951978fffe35',
  'dfa6e92b-8507-45e2-8331-78345bca841d','53fb4f7d-807e-4302-9494-f865bc21a02d',
];
...
async function main() {
  ...
  for (const u of newUserDefs) {
    ...
    if (found) {
      ...
      const { data, error } = await admin.auth.admin.createUser({
        email: u.email, password: 'TestPass123!', email_confirm: true,
      });
  ...
  for (let teamIdx = 0; teamIdx < 4; teamIdx++) {
    ...
    console.log(`  roster assigned: ${allUsers[teamIdx].teamName} (${draftAssignments[teamIdx].length} fighters)`);
  }
  ...
  const scoreMap: Record<string, { home: number; away: number }[]> = {
    [COMPLETED_EVENTS[0]]: [{ home: 1850, away: 1400 }, { home: 1700, away: 1350 }],
    [COMPLETED_EVENTS[1]]: [{ home: 1900, away: 1650 }, { home: 2000, away: 1500 }],
  };
  ...
  standings.forEach((s, i) => {
    console.log(`  #${i + 1} ${s.team_name}  ${s.wins}W-${s.losses}L  ${(+s.total_points).toFixed(0)} pts`);
  });
